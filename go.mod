module github.com/strips-finance/rabbit-dex-backend

go 1.19

require (
	github.com/Code-Hex/sigctx v0.0.0-20170411072940-05e1d0fd7ea4
...
replace github.com/dontpanicdao/caigo => github.com/alex-sumner/caigo v0.0.0-20221221092313-2d7743a9ec3b
