...
// MAXL1MSGFEE is a free data retrieval call binding the contract method 0x7cbe06d1.
//
// Solidity: function MAX_L1_MSG_FEE() view returns(uint256)
func (_StarknetCore *StarknetCoreCaller) MAXL1MSGFEE(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StarknetCore.contract.Call(opts, &out, "MAX_L1_MSG_FEE")
...
//
// Solidity: function MAX_L1_MSG_FEE() view returns(uint256)
func (_StarknetCore *StarknetCoreSession) MAXL1MSGFEE() (*big.Int, error) {
	return _StarknetCore.Contract.MAXL1MSGFEE(&_StarknetCore.CallOpts)
}

// MAXL1MSGFEE is a free data retrieval call binding the contract method 0x7cbe06d1.
//
// Solidity: function MAX_L1_MSG_FEE() view returns(uint256)
func (_StarknetCore *StarknetCoreCallerSession) MAXL1MSGFEE() (*big.Int, error) {
	return _StarknetCore.Contract.MAXL1MSGFEE(&_StarknetCore.CallOpts)
}
